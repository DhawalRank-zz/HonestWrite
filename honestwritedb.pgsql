...
49	Can add sysuser	17	add_sysuser
50	Can change sysuser	17	change_sysuser
51	Can delete sysuser	17	delete_sysuser
\.
...
1	pbkdf2_sha256$24000$I3UFSccwGh1r$lkaIdRLGUK7diBPkz1lq5T4DPlw9ywsnRHuwdFY7Tl4=	2016-05-16 12:48:55.113375-04	t	rank			sojitradhawal@gmail.com	t	t	2016-05-14 19:25:14.297626-04
2	pbkdf2_sha256$24000$PDsOwcD0ZlPG$gyTc3CGZSTiZivm7VOaMNhKMuJDeKp86H8VKD0NDeS4=	2016-05-16 13:14:24.952616-04	f	DhawalRank	Dhawal	Rank	rank@uwindsor.ca	f	t	2016-05-14 19:26:30.754933-04
\.
...
COPY class (id, uname, style, topic, duedate) FROM stdin;
\.
...
6	sessions	session
7	core	authgroup
8	core	authgrouppermissions
9	core	authpermission
10	core	authuser
11	core	authusergroups
12	core	authuseruserpermissions
13	core	djangoadminlog
14	core	djangocontenttype
15	core	djangomigrations
16	core	djangosession
17	core	sysuser
\.
...
1	contenttypes	0001_initial	2016-05-14 19:24:31.876965-04
2	auth	0001_initial	2016-05-14 19:24:32.732987-04
3	admin	0001_initial	2016-05-14 19:24:32.891483-04
4	admin	0002_logentry_remove_auto_add	2016-05-14 19:24:32.907824-04
5	contenttypes	0002_remove_content_type_name	2016-05-14 19:24:32.935898-04
6	auth	0002_alter_permission_name_max_length	2016-05-14 19:24:32.947957-04
7	auth	0003_alter_user_email_max_length	2016-05-14 19:24:32.961967-04
8	auth	0004_alter_user_username_opts	2016-05-14 19:24:32.97099-04
9	auth	0005_alter_user_last_login_null	2016-05-14 19:24:32.984523-04
10	auth	0006_require_contenttypes_0002	2016-05-14 19:24:32.987533-04
11	auth	0007_alter_validators_add_error_messages	2016-05-14 19:24:32.997427-04
12	sessions	0001_initial	2016-05-14 19:24:33.152513-04
13	core	0001_initial	2016-05-16 13:14:00.113437-04
\.
...
0mux96j9kfxu0698sxzmgnyvy59q557q	ODdjNTM2ODNkOGJlODE5ZjkwZjYxNjNhOWEyMGMwZWRjZDQ4MGQ5NTp7Il9hdXRoX3VzZXJfYmFja2VuZCI6ImRqYW5nby5jb250cmliLmF1dGguYmFja2VuZHMuTW9kZWxCYWNrZW5kIiwiX2F1dGhfdXNlcl9pZCI6IjIiLCJfYXV0aF91c2VyX2hhc2giOiJlMTJiNzg3OThlYmI2NDAwNzk5MzUzMDVlMTFjYTljZDY4YzhhYWUxIn0=	2016-05-30 13:14:24.977129-04
\.
...
COPY faculty (id, uname, school, faculty, program, major) FROM stdin;
\.
...
--
-- Name: class_id_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: faculty_pk; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: class_uname_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY class
    ADD CONSTRAINT class_uname_fk FOREIGN KEY (uname) REFERENCES auth_user(username);
...
--
-- Name: uname_fk; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY faculty
    ADD CONSTRAINT uname_fk FOREIGN KEY (uname) REFERENCES auth_user(username);
...
GRANT ALL ON TABLE faculty TO PUBLIC;
